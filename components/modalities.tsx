  ...
  return (
    <section className="relative overflow-hidden bg-transparent">
      <img
        ...
        className="pointer-events-none absolute -right-6 top-1/2 -translate-y-1/2 hidden h-[82%] sm:h-[86%] w-auto object-contain opacity-[0.12] mix-blend-multiply scale-x-[-1] [mask-image:linear-gradient(to_bottom,transparent_0%,black_12%,black_88%,transparent_100%)] md:block"
        loading="lazy"
      />
